...
<div class="container">
    ...
    <div class="container" style="margin-top: 10px">
        <div class="row">
            <button class="btn btn-primary" data-backdrop='false' data-toggle="modal" data-target="#addModal"><i class="fa fa-plus"></i> Add Single User</button>
        </div>
        <br>
        <div class="row">
        ...
        <br>
        <div class="row">
            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-hover" id="userTable">
                <thead>
                <tr>
                    <th>S.No</th>
                    <th>User Name</th>
                    ...
                    <th class="deleteTableHeader">Delete</th>
                </tr>
                </thead>
                <tbody>
                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form role="form" id="addUserForm" method="get" action="admin/user/addSingleUser">
    ...
    <div class="modal fade" id='dModal'>
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label id='delUserName'>Are you sure you want to delete</label>
                    <input type="hidden" id="dUserId"/>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                    <button type="button" class="btn btn-primary" id='deleteUserBtn'>Yes</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
